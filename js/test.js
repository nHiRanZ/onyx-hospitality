    ...
    "lib/paymentMethods": function (exports, require, module) {
        (function () {
            ...
            METHODS = {
                ...
                card: {
                    method: {importance: REQUIRED, spec: optionValidator.ignore, checkContext: optionValidator.ignore},
                    enabled: {
                        importance: OPTIONAL,
            ...
            spec = function (key, val, options) {
                ...
                if (!helpers.isArray(val)) {
                    ...
                    return {type: ERROR, message: "Looking for an Array, but instead we found '" + actualType + "'."}
                }
            ...
            alipayToCanonical = function (enabled, reusable) {
                var methodSettings;
                methodSettings = {method: "alipay", enabled: enabled, reusable: reusable};
...
StripeCheckout.require.define({
    "lib/optionSpecs": function (exports, require, module) {
        (function () {
            ...
            OPTIONS = {
                address: {
                    importance: PRIVATE, type: OTHER, checkContext: function (key, val, options) {
                ...
                alipay: {
                    importance: OPTIONAL, type: OTHER, coerceTo: function (val) {
                        if (val === "auto") {
                            return val
                        }
                ...
                allowRememberMe: {importance: OPTIONAL, type: NULLABLE_BOOLEAN, "default": true},
                ...
                buttonIntegration: {importance: PRIVATE, type: BOOLEAN, "default": false},
                closed: {only: CUSTOM, importance: OPTIONAL, type: OTHER},
                color: {importance: PRIVATE, type: STRING},
                currency: {importance: OPTIONAL, type: NULLABLE_STRING, "default": "usd"},
                ...
                token: {importance: EVENTUALLY_REQUIRED, type: OTHER},
            ...
            BUTTON_CONFIGURE_OPTIONS = generateOptions({only: BUTTON, isConfigure: true});
            BUTTON_OPEN_OPTIONS = generateOptions({only: BUTTON, isConfigure: false});
            CUSTOM_CONFIGURE_OPTIONS = generateOptions({only: CUSTOM, isConfigure: true});
            CUSTOM_OPEN_OPTIONS = generateOptions({only: CUSTOM, isConfigure: false});
            module.exports = {
                _OPTIONS: OPTIONS,
                types: {
                    STRING: STRING,
    ...
    "lib/optionValidator": function (exports, require, module) {
        (function () {
            ...
            fromSpec = function (optionSpec) {
                var opt, val;
                return {
                    all: optionSpec, required: function () {
                        var _results;
                        _results = [];
            ...
            ErrorMisspelledRequired = function () {
                ...
                ErrorMisspelledRequired.prototype.trackedInfo = function () {
                    return {result: "ErrorMisspelledRequired", expected: this.expected, actual: this.actual}
                };
            ...
            WarnMisspelledOptional = function () {
                ...
                WarnMisspelledOptional.prototype.trackedInfo = function () {
                    return {result: "WarnMisspelledOptional", expected: this.expected, actual: this.actual}
                };
            ...
            WarnOptionTypeError = function () {
                ...
                WarnOptionTypeError.prototype.trackedInfo = function () {
                    return {result: "WarnOptionTypeError", key: this.key, message: this.message}
                };
            ...
            WarnBadContext = function () {
                ...
                WarnBadContext.prototype.trackedInfo = function () {
                    return {result: "WarnBadContext", key: this.key, message: this.message}
                };
            ...
            validate = function (optionSpec, rawOptions) {
                ...
                errors = [];
                warnings = [];
                checkRequiredOptions(OPTIONS, {errors: errors, warnings: warnings}, rawOptions);
        ...
        (function () {
            ...
            module.exports = {
                coerceButtonOption: function (option, val) {
                    ...
                    trackSummary({origin: origin, numErrors: numErrors, numWarnings: numWarnings}, rawOptions);
        ...
        (function () {
            ...
            Checkout = function () {
                ...
                function Checkout(tokenCallback, options, configOptions) {
                    ...
                    this.shouldPopup = helpers.isSupportedMobileOS() && !this.isMobileWebView;
                ...
                Checkout.prototype.createView = function (useManhattan) {
                    ...
                    views = {FallbackView: FallbackView, IframeView: IframeView, TabView: TabView};
                    ...
                    path = function () {
                        switch (false) {
                            ...
                            case!useManhattan:
                                return "/m/v3/index-15afdac2f7484549293f.html";
                            default:
                    ...
                    cb = function (_this) {
                        return function () {
                            ...
                            iframeFallback = function () {
                                ...
                                this.view = new IframeView(this.onToken, this.host, "/v3/jDnNl6JuCwDhUeV74LrwEQ.html");
                ...
                Checkout.prototype.shouldUseManhattan = function (cb, options) {
                    ...
                    if (helpers.isFallback() || this.isMobileWebView) {
                        cb(this.forceManhattan);
    ...
    "outer/views/tabView": function (exports, require, module) {
        (function () {
            ...
            TabView = function (_super) {
                ...
                function TabView() {
                    this.invokeOnToken = __bind(this.invokeOnToken, this);
                    this.closed = __bind(this.closed, this);
...
/**
 * Created by yohan on 17/01/2017.
 */
