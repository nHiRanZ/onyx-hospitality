...
<div class="container col-md-12 col-sm-12 col-xs-12" style="overflow: scroll">
    <div class="highlight" style="height: 12%;">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 fill map-container" style="float:left; background-color: #888888; padding:0px 0px;">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 containertext center game-container" style="position: relative">
        <div class="row">
