<header class="header-main-test">
    <div class="col-md-12 col-sm-12 col-xs-12" style="padding:0px 0px 0px 0px;">
        <div id="mySidenav" class="sidenav">
            ...
            <a href="search.php">HOTELS<i class="fa fa-hotel" style="float: right; margin-right:50px"></i></a>
            <a href="reservation.php">RESERVATIONS<i class="fa fa-tags" style="float: right; margin-right:50px"></i></a>
            <a href="about.php">ABOUT US<i class="fa fa-commenting-o" style="float: right; margin-right:50px"></i></a>
            <a href="contact.php">CONTACT<i class="fa fa-phone" style="float: right; margin-right:50px"></i></a>
            <a href="login.php">LOGOUT<i class="fa fa-sign-out" style="float: right; margin-right:50px"></i></a>
        </div>
    </div>
</header>